				...
				<div class="col-lg-4 col-md-8 col-sm-8">		
					<div class="pr-10 pr-sm-0">	
						...
						<?php if($counter <= 2 ): ?>
							<div class="sided-80x mb-30">
								<a class="s-left" href="#">
									<img src="<?php echo e(url('images/backend_images/post_images/large/'.$post->post_image)); ?>" alt="">
									<!--<div class="hover-video sm"><span class="icon"><i class="ion-play"></i></span></div>-->
								</a><!-- s-left -->
...
<?php /* D:\NationLive\NationLiveNews\resources\views/layouts/frontLayouts/front_footer.blade.php */ ?>