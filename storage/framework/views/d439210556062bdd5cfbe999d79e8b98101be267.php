        ...
        <div class="row">
            <div class="col-xs-12 col-md-12 col-lg-12">
                ...
                <div class="box box-purple">
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form method="post" action="<?php echo e(url('/admin/new-post')); ?>" enctype="multipart/form-data" name="add_post" id="add_post" novalidate="novalidate">
...
<?php /* /home/laiz37yervyw/resources/views/admin/posts/add_new_post.blade.php */ ?>