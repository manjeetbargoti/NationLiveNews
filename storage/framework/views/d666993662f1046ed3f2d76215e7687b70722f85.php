		...
		<div class="container">
			...
			<div class="video_carousel">
				<div class="video-carousel owl-carousel owl-theme">
					...
					<div class="item">
						<div class="video_box">
							<a class="hover-grey dplay-block" href="<?php echo e(url('/news/'.$post->post_url)); ?>">
								<div class="pos-relative">
									<!-- <img src="https://youtu.be/Mr3iH7qTJfk" alt=""> -->
								...
								<h5 class="mt-15"><b><?php echo e(strip_tags(str_limit($post->post_title, $limit=50))); ?></b></h5></a>
...
<?php /* D:\NationLive\NationLiveNews\resources\views/home.blade.php */ ?>