              ...
              <?php $i++ ?>
                <li class="item">
                  ...
                  <div class="product-info">
                      ...
                      <a target="_blank" href="{{ url('/news/'.$post->post_url) }}" class="product-title">{!! str_limit($post->post_title, $limit=50) !!}</a>
                  </div>
                </li>
              @endif  
              @endforeach  
          ...
          <div class="box box-danger">
            ...
            <div class="box-body no-padding">
              <ul class="users-list clearfix">
                ...
                <li>
                  <img src="{{ url('dist/img/user8-128x128.jpg') }}" alt="User Image">
                  <a class="users-list-name" href="#">Norman</a>
                  <span class="users-list-date">Yesterday</span>
                </li>
                <li>
                  <img src="{{ url('dist/img/user7-128x128.jpg') }}" alt="User Image">
                  <a class="users-list-name" href="#">Jane</a>
                  <span class="users-list-date">12 Jan</span>
                </li>
                <li>
                  <img src="{{ url('dist/img/user6-128x128.jpg') }}" alt="User Image">
                ...
                <li>
                  <img src="{{ url('dist/img/user5-128x128.jpg') }}" alt="User Image">
                  <a class="users-list-name" href="#">Sarah</a>
                  <span class="users-list-date">14 Jan</span>
                </li>
                <li>
                  <img src="{{ url('dist/img/user4-128x128.jpg') }}" alt="User Image">
                  <a class="users-list-name" href="#">Nora</a>
                  <span class="users-list-date">15 Jan</span>
                </li>
                <li>
                  <img src="{{ url('dist/img/user3-128x128.jpg') }}" alt="User Image">
